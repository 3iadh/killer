...
return [
    ...
    'filesystem' => [
        ...
        'root_url' => '/killer/storage/uploads',
        'root_thumb_url' => '/killer/storage/uploads/thumbs',
        //   'key'    => 's3-key',
        //   'secret' => 's3-key',
        //   'region' => 's3-region',
        //   'version' => 's3-version',
    ...
    'mail' => [
        'transport' => 'mail',
        'from' => 'ayawo-dela-fiogbo.ameganvi@capgemini.com'
    ],

    'cors' => [
        'enabled' => true, //Par défaut il est à False donc le mettre à true
        'origin' => '*',
        'headers' => [
    ...
    'feedback' => [
        'token' => '03cb89c1f52ed967c21e65c32aaf62ef5bc989ae',
        'login' => true
    ],
